...
impl NetworkManager {
    ...
    pub fn start<T: DeserializeOwned>(
        ...
        self.inner.start(on_open_callback, on_message_callback, on_disconnect_callback);
    }
    ...
    pub fn start_with_retransmits<T: DeserializeOwned>(
        ...
        self.inner
            .start_with_retransmits(max_retransmits, on_open_callback, on_message_callback, on_disconnect_callback);
    }
